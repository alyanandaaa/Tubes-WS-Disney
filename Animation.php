...
<h1 class="wow animated bounceInLeft">Walt Disney Animation</h1>
</div>

<div class="sec-title text-center">
<form action="a1.php" method="post" class="wow animated bounceInDown">
...
<div class="sec-title text-center">
<p>Jumlah film Animasi: <?= $result->numRows() ?></p> 
</div>
