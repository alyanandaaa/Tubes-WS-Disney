...
<head>
 ...
 <body style="background-color: pink;"><header id="navigation" class="navbar-inverse navbar-fixed-top animated-header">
            <div class="container">
...
<h1><strong><br><br>Disney Comic Character</strong></h1>

<ul>
<?php

    $result = $sparql->query(
        'SELECT DISTINCT ?id ?Nama ?Gender ?first{'.
        '  ?id dct:subject dbc:Disney_comics_characters.'.
    '  ?id foaf:name ?Nama.'.
    '  ?id foaf:gender ?Gender.'.
    '  ?id dbo:firstAppearance ?first'.
    '} ORDER BY ASC (?Nama)'
    );
    ?>
    ...
    <tr align="center">
      ...
      <th><center>First Appearance</center></th>
    </tr>
</thead>
