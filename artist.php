...
<h1 class="wow animated bounceInLeft">Artist</h1>
</div>

<div class="sec-title text-center">
<form action="art.php" method="get" class="5wow animated bounceInDown">
  <center><div class="form-group">
    <select class="form-control" id="exampleFormControlSelect1" name="nama" style="width: 60%;">
  <option value="all">--What's your favorite artist?--</option>
  <?php foreach ($result as $row) : ?>
    <?php $nama = substr($row->id, 28) ?>
  <option value="<?php echo $nama ?>"><?php echo $row->nama ?></option>;
  <?php endforeach ; ?>
 </select>
</div>
...
<div class="sec-title text-center">
<p>Jumlah artist: <?= $result->numRows() ?></p>
</div>
