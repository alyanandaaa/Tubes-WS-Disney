...
<h1 class="wow animated bounceInLeft">Music Single</h1>
</div>

<div class="sec-title text-center">
<form action="s.php" method="post" class="wow animated bounceInDown">
  <center><div class="form-group">
    <select class="form-control" id="exampleFormControlSelect1" name="single" style="width: 60%;">
  <option value="all">--What's your favorite single?--</option>
  <?php foreach ($result as $row) : ?>
 
  <option value= "<?php echo $row->single ?>"><?php echo $row->single ?></option>;
  <?php endforeach ; ?>
  ?>
</select>
</div>
...
<div class="sec-title text-center">
<p>Jumlah lagu: <?= $result->numRows() ?></p>
</div>
